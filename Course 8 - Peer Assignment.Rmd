...
Various relationships were explored, out of which the __roll_belt__, __pitch_bell__, and __yaw_belt__ showed the most variability with exercise type and the individual.
```{r}
ggplot(training, aes(pitch_belt, yaw_belt, color = user_name)) +
  geom_point(alpha=.1) + geom_jitter(width=30, height=30) + 
